...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Editar Perfil do Utilizador </h4>
...
@csrf
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Utilizador</label>
                <div class="col-sm-10">
            ...
            <!-- end row -->
<input type="submit" class="btn btn-info waves-effect waves-light" value="Atualizar Perfil">
            </form>

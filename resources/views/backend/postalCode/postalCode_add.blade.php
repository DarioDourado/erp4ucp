            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Adicionar Código Postal</h4>
                        <br><br>
                        ...
                        <form method="post" action="{{ route('postalCode.store') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input id="postalCode" name="postalCode" class="form-control" type="text" autofocus>
                                </div>
                            </div>
                            ...
                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Adicionar CP">
                        </form>

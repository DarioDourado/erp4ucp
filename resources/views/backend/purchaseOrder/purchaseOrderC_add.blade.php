        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Nova Encomenda a Fornecedor</h4>
                </div>
            </div>
        </div>

        <form method="post" action="{{ route('purchaseOrder.store') }}" id="myForm" novalidate>
            @csrf
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input id="pONumber"
                                               ...
                                               value="{{ old('pONumber', $nextPONumber > 0 ? $nextPONumber : '') }}">
                                        @error('pONumber')
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input id="pODate"
                                               ...
                                               value="{{ old('pODate', now()->format('Y-m-d')) }}">
                                        @error('pODate')
                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-4">
                                ...
                                <span id="headerReadyBadge" class="badge bg-warning text-dark">
                                    Preencha o cabeçalho para adicionar linha
                                </span>
                            </div>
...
@push('styles')
    @vite('resources/css/purchaseOrder/purchaseOrderC_add.css')
@endpush

@push('scripts')
    @vite('resources/js/purchaseOrder/purchaseOrderC_add.js')
@endpush
